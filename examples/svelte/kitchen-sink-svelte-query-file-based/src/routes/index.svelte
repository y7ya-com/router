...
<div class="page">
  <h1>TanStack Router + Query · Svelte</h1>
  <p>
    A file-based router demo wired to <strong>TanStack Query</strong> via
    <code>@tanstack/svelte-router-ssr-query</code>. What it shows:
  </p>
  <ul>
  ...
  <p><Link to="/posts">→ Open Posts</Link></p>
</div>
